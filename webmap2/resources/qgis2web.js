...
map.getView().fit([1097981.620540, 7078989.914320, 1126534.694225, 7097921.843611], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Railways in Hamburg</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (31 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Railway stations around Hamburg';
            }
